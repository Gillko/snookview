			    ...
			    {  
				    ...
				    <div class="col-md-3 noPaddingTablet noPaddingMobile text-center">
						<div class="box">
							...
							<p class="tournament-name"><?php echo $this->Html->link(__($tournament['Tournament']['tournament_name']), array('controller' => 'tournaments', 'action' => 'view', $tournament['Tournament']['tournament_id'])); ?></p>
